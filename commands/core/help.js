...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        embed.setDescription('Access to open source music bot: [RaykujanK13](https://github.com/Rimba5446/sayuchan), need more help You can get help by joining our Discord Community.\nHow about creating your own music world?') ;
